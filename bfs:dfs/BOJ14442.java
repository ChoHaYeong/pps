...
//                 else if(out.cnt != 0 && out.cnt <= K)
//                     System.out.println(dist[out.x][out.y][1]);
//                 else
//                     System.out.println(dist[out.x][out.y][0]);
//                 flag = true;
//                 return ;
//             }

//             // if(out.x == N-1 && out.y == M-1 && out.cnt >= K){
//             //     System.out.println(-1);
//             // }
...
//                 //else if(dist[nx][ny][0] == -1 || dist[nx][ny][1] == -1) continue;       
//                 else if(map[nx][ny] == 0) { //벽이 아닐 때 => 해당 위치에서는 벽을 부술 필요가 없음
//                     if(out.cnt == 0 && dist[nx][ny][0] == -1) { //벽을 부순적이 없다면
//                         //visited[nx][ny][0] = true;
//                         queue.add(new Wall(nx, ny, out.cnt));
//                         dist[nx][ny][0] = dist[out.x][out.y][0]+1;
//                     } 
//                     else if(out.cnt != 0 && out.cnt <= K && dist[nx][ny][1] == -1) { //벽을 부순적이 있다면
...
//                     if(out.cnt == 0 && dist[nx][ny][0] == -1) { //벽을 부순적이 없으면
//                         dist[nx][ny][1] = dist[out.x][out.y][0] + 1;
//                     } 
//                     else if(out.cnt != 0 && out.cnt < K ) { //벽을 부순적이 있으면
//                         dist[nx][ny][1] = dist[out.x][out.y][1] + 1;
//                     }
